...
export const activities: Activity[] = [
  ...
  { title: 'Vice Society', done: false, date: '' },
  { title: 'Recess', done: false, date: '' },
  { title: 'Potbelly\'s', done: false, date: '' },
  { title: 'The Tally Strip', done: false, date: '' },
  { title: 'Bajas ', done: false, date: '' },
  { title: 'Clydes & Costello\'s', done: false, date: '' },
  { title: 'Bullwinkle\'s Saloon', done: false, date: '' },
  { title: 'The Palace Saloon', done: false, date: '' },
  { title: 'Poor Paul\'s Pourhouse', done: false, date: '' },
  ...
  { title: 'Create a Music Video', done: false, date: '' },
